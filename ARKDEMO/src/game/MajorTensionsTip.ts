namespace game {
    export class MajorTensionsTip extends egret.DisplayObjectContainer {
        ...
        private tipText(): void {
            ...
            title.text = "Higher numbers indicate bigger tensions betw-een your self-perception & the teams attribution of your position on the scale:"
            title.size = 30
            title.x = 0
            title.y = 0
            ...
            content.text = "• White values: mark areas of authentic action.            • Values over 13: indicate your dissociative eff-ect on the team‘s organizing dynamics.\                  • Red values: mark your self- perception as bei-ng outside ZORA.                                                    • Yellow Values: mark your attributed position as being outside ZORA."
            content.size = 30
            content.x = 0
            content.y = 90
